...
#define SD_SDIO_AF_CKIN  LL_GPIO_AF_7
#define SD_SDIO_PIN_CKIN GPIO_PIN(GPIOB, 8)

#define SD_SDIO_AF_CDIR  LL_GPIO_AF_7
#define SD_SDIO_PIN_CDIR GPIO_PIN(GPIOB, 9)

#define SD_SDIO_AF_D0DIR LL_GPIO_AF_8
#define SD_SDIO_PIN_D0DIR GPIO_PIN(GPIOC, 6)

#define SD_SDIO_AF_D123DIR LL_GPIO_AF_8
#define SD_SDIO_PIN_D123DIR GPIO_PIN(GPIOC, 7)
